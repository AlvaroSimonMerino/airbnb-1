...
#max(outliers.rm(data_train$price_per_person))
#max(outliers.rm(data_train$price))
#max(outliers.rm(data_train$accommodates))
#max(outliers.rm(data_train$minimum_nights))
