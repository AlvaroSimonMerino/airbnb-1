...
model <- lm(log(price)~latitude+accommodates:bedrooms+beds+host_since+availability_365+room_type+neighbourhood_group_cleansed+review_scores_rating+review_scores_value+review_scores_cleanliness+review_scores_communication, data=data) # Al hacer log del precio, el R² queda casi 0.6
