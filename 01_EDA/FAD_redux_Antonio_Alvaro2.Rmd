...
Comprobamos que no queden NA en el conjunto de datos de salida:
...
Se observa que *data_train* ya no tiene datos faltantes y podemos trabajar con los datos de una forma más eficaz.
