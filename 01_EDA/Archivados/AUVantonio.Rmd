...
```{r availability_365}
ggplot(data, aes(x=availability_365)) + geom_histogram(stat="count") # TODO Profundizar más
...
outliers <- data[data$price > quantile(data$price)[4],]
...
Yo todo lo que supere los 105-150€/persona lo quitaba