...
Este modelo es el más adecuado para nuestros requisitos, por lo que es lo que vamos a probar en los datos de *test*.
...
Como resultado, vemos que el modelo también funciona bien en los datos de *test*, al igual que en los datos de *train*. Para este modelo en *train*, el valor de R^2 fue 0.6247, para *test* - 0.6221.
