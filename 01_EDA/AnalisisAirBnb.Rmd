...
En primer lugar, comprobamos que nuestro conjunto de datos tiene 22 variables, aunque no todas han sido clasificadas con el tipo que esperaríamos. $host_since$ debería ser fecha, $host_is_superhost$ debería ser un booleano y $price$ debería ser numérico.
