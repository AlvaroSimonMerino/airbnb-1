...
Puesto que el número de personas por espacio ($accommodates$) nos parece la que mejor representa la ocupación, se descartarán las variables $bedrooms$ y $beds$.
...
Además, existe la variable $host\_is\_superhost$, que indica un grado de excelencia otorgado por la plataforma al arrendatario en base a los siguientes criterios:
